...
public class TextMenu {
      ...
      if (choice <= 6) {
        switch (choice) {
          ...
          case 1: // To add ingredient
            Ingredient ingredient = addIngredientsMenu(scanner);
  ...
  private void listAllIngredients(Scanner scanner) {
    ...
    allNames = ingredients.getAllNames();
  ...
  private void addRecipeMenu(Scanner scanner) {
    ...
    while (keepAddIngredient) {
      Ingredient ingredient = addIngredientsToRecipe(scanner);
